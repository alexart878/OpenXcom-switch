...
void create()
{
	...
	_info.push_back(OptionInfo("displayWidth", &displayWidth, Screen::ORIGINAL_WIDTH*4));
	_info.push_back(OptionInfo("displayHeight", &displayHeight, Screen::ORIGINAL_HEIGHT*(3.6)));
	_info.push_back(OptionInfo("fullscreen", &fullscreen, true));
...
// this should probably be any small screen touch-device, i don't know the defines for all of them so i'll cover android and IOS as i imagine they're more common
	...
	// controls
	_info.push_back(OptionInfo("keyOk", (SDL_KeyWrapper *) &keyOk, {SDLK_RETURN}, "STR_OK", "STR_GENERAL"));
	_info.push_back(OptionInfo("keyCancel", (SDL_KeyWrapper *) &keyCancel, {SDLK_ESCAPE}, "STR_CANCEL", "STR_GENERAL"));
	_info.push_back(OptionInfo("keyScreenshot", (SDL_KeyWrapper *) &keyScreenshot, {SDLK_F12}, "STR_SCREENSHOT", "STR_GENERAL"));
	_info.push_back(OptionInfo("keyFps", (SDL_KeyWrapper *) &keyFps, {SDLK_F7}, "STR_FPS_COUNTER", "STR_GENERAL"));
	_info.push_back(OptionInfo("keyQuickSave", (SDL_KeyWrapper *) &keyQuickSave, {SDLK_F5}, "STR_QUICK_SAVE", "STR_GENERAL"));
	_info.push_back(OptionInfo("keyQuickLoad", (SDL_KeyWrapper *) &keyQuickLoad, {SDLK_F9}, "STR_QUICK_LOAD", "STR_GENERAL"));
	_info.push_back(OptionInfo("keyGeoLeft", (SDL_KeyWrapper *) &keyGeoLeft, {SDLK_LEFT}, "STR_ROTATE_LEFT", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoRight", (SDL_KeyWrapper *) &keyGeoRight, {SDLK_RIGHT}, "STR_ROTATE_RIGHT", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoUp", (SDL_KeyWrapper *) &keyGeoUp, {SDLK_UP}, "STR_ROTATE_UP", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoDown", (SDL_KeyWrapper *) &keyGeoDown, {SDLK_DOWN}, "STR_ROTATE_DOWN", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoZoomIn", (SDL_KeyWrapper *) &keyGeoZoomIn, {SDLK_PLUS}, "STR_ZOOM_IN", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoZoomOut", (SDL_KeyWrapper *) &keyGeoZoomOut, {SDLK_MINUS}, "STR_ZOOM_OUT", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed1", (SDL_KeyWrapper *) &keyGeoSpeed1, {SDLK_1}, "STR_5_SECONDS", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed2", (SDL_KeyWrapper *) &keyGeoSpeed2, {SDLK_2}, "STR_1_MINUTE", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed3", (SDL_KeyWrapper *) &keyGeoSpeed3, {SDLK_3}, "STR_5_MINUTES", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed4", (SDL_KeyWrapper *) &keyGeoSpeed4, {SDLK_4}, "STR_30_MINUTES", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed5", (SDL_KeyWrapper *) &keyGeoSpeed5, {SDLK_5}, "STR_1_HOUR", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoSpeed6", (SDL_KeyWrapper *) &keyGeoSpeed6, {SDLK_6}, "STR_1_DAY", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoIntercept", (SDL_KeyWrapper *) &keyGeoIntercept, {SDLK_i}, "STR_INTERCEPT", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoBases", (SDL_KeyWrapper *) &keyGeoBases, {SDLK_b}, "STR_BASES", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoGraphs", (SDL_KeyWrapper *) &keyGeoGraphs, {SDLK_g}, "STR_GRAPHS", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoUfopedia", (SDL_KeyWrapper *) &keyGeoUfopedia, {SDLK_u}, "STR_UFOPAEDIA_UC", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoOptions", (SDL_KeyWrapper *) &keyGeoOptions, {SDLK_ESCAPE}, "STR_OPTIONS_UC", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoFunding", (SDL_KeyWrapper *) &keyGeoFunding, {SDLK_f}, "STR_FUNDING_UC", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoToggleDetail", (SDL_KeyWrapper *) &keyGeoToggleDetail, {SDLK_TAB}, "STR_TOGGLE_COUNTRY_DETAIL", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyGeoToggleRadar", (SDL_KeyWrapper *) &keyGeoToggleRadar, {SDLK_r}, "STR_TOGGLE_RADAR_RANGES", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyBaseSelect1", (SDL_KeyWrapper *) &keyBaseSelect1, {SDLK_1}, "STR_SELECT_BASE_1", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyBaseSelect2", (SDL_KeyWrapper *) &keyBaseSelect2, {SDLK_2}, "STR_SELECT_BASE_2", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyBaseSelect3", (SDL_KeyWrapper *) &keyBaseSelect3, {SDLK_3}, "STR_SELECT_BASE_3", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyBaseSelect4", (SDL_KeyWrapper *) &keyBaseSelect4, {SDLK_4}, "STR_SELECT_BASE_4", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyBaseSelect5", (SDL_KeyWrapper *) &keyBaseSelect5, {SDLK_5}, "STR_SELECT_BASE_5", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyBaseSelect6", (SDL_KeyWrapper *) &keyBaseSelect6, {SDLK_6}, "STR_SELECT_BASE_6", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyBaseSelect7", (SDL_KeyWrapper *) &keyBaseSelect7, {SDLK_7}, "STR_SELECT_BASE_7", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyBaseSelect8", (SDL_KeyWrapper *) &keyBaseSelect8, {SDLK_8}, "STR_SELECT_BASE_8", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("keyBattleLeft", (SDL_KeyWrapper *) &keyBattleLeft, {SDLK_LEFT}, "STR_SCROLL_LEFT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleRight", (SDL_KeyWrapper *) &keyBattleRight, {SDLK_RIGHT}, "STR_SCROLL_RIGHT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleUp", (SDL_KeyWrapper *) &keyBattleUp, {SDLK_UP}, "STR_SCROLL_UP", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleDown", (SDL_KeyWrapper *) &keyBattleDown, {SDLK_DOWN}, "STR_SCROLL_DOWN", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleLevelUp", (SDL_KeyWrapper *) &keyBattleLevelUp, {SDLK_PAGEUP}, "STR_VIEW_LEVEL_ABOVE", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleLevelDown", (SDL_KeyWrapper *) &keyBattleLevelDown, {SDLK_PAGEDOWN}, "STR_VIEW_LEVEL_BELOW", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterUnit", (SDL_KeyWrapper *) &keyBattleCenterUnit, {SDLK_HOME}, "STR_CENTER_SELECTED_UNIT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattlePrevUnit", (SDL_KeyWrapper *) &keyBattlePrevUnit, {SDLK_LSHIFT}, "STR_PREVIOUS_UNIT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleNextUnit", (SDL_KeyWrapper *) &keyBattleNextUnit, {SDLK_TAB}, "STR_NEXT_UNIT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleDeselectUnit", (SDL_KeyWrapper *) &keyBattleDeselectUnit, {SDLK_BACKSLASH}, "STR_DESELECT_UNIT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleUseLeftHand", (SDL_KeyWrapper *) &keyBattleUseLeftHand, {SDLK_q}, "STR_USE_LEFT_HAND", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleUseRightHand", (SDL_KeyWrapper *) &keyBattleUseRightHand, {SDLK_e}, "STR_USE_RIGHT_HAND", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleInventory", (SDL_KeyWrapper *) &keyBattleInventory, {SDLK_i}, "STR_INVENTORY", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleMap", (SDL_KeyWrapper *) &keyBattleMap, {SDLK_m}, "STR_MINIMAP", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleOptions", (SDL_KeyWrapper *) &keyBattleOptions, {SDLK_ESCAPE}, "STR_OPTIONS", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleEndTurn", (SDL_KeyWrapper *) &keyBattleEndTurn, {SDLK_BACKSPACE}, "STR_END_TURN", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleAbort", (SDL_KeyWrapper *) &keyBattleAbort, {SDLK_a}, "STR_ABORT_MISSION", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleStats", (SDL_KeyWrapper *) &keyBattleStats, {SDLK_s}, "STR_UNIT_STATS", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleKneel", (SDL_KeyWrapper *) &keyBattleKneel, {SDLK_k}, "STR_KNEEL", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleReload", (SDL_KeyWrapper *) &keyBattleReload, {SDLK_r}, "STR_RELOAD", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattlePersonalLighting", (SDL_KeyWrapper *) &keyBattlePersonalLighting, {SDLK_l}, "STR_TOGGLE_PERSONAL_LIGHTING", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleReserveNone", (SDL_KeyWrapper *) &keyBattleReserveNone, {SDLK_F1}, "STR_DONT_RESERVE_TIME_UNITS", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleReserveSnap", (SDL_KeyWrapper *) &keyBattleReserveSnap, {SDLK_F2}, "STR_RESERVE_TIME_UNITS_FOR_SNAP_SHOT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleReserveAimed", (SDL_KeyWrapper *) &keyBattleReserveAimed, {SDLK_F3}, "STR_RESERVE_TIME_UNITS_FOR_AIMED_SHOT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleReserveAuto", (SDL_KeyWrapper *) &keyBattleReserveAuto, {SDLK_F4}, "STR_RESERVE_TIME_UNITS_FOR_AUTO_SHOT", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleReserveKneel", (SDL_KeyWrapper *) &keyBattleReserveKneel, {SDLK_j}, "STR_RESERVE_TIME_UNITS_FOR_KNEEL", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleZeroTUs", (SDL_KeyWrapper *) &keyBattleZeroTUs, {SDLK_DELETE}, "STR_EXPEND_ALL_TIME_UNITS", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy1", (SDL_KeyWrapper *) &keyBattleCenterEnemy1, {SDLK_1}, "STR_CENTER_ON_ENEMY_1", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy2", (SDL_KeyWrapper *) &keyBattleCenterEnemy2, {SDLK_2}, "STR_CENTER_ON_ENEMY_2", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy3", (SDL_KeyWrapper *) &keyBattleCenterEnemy3, {SDLK_3}, "STR_CENTER_ON_ENEMY_3", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy4", (SDL_KeyWrapper *) &keyBattleCenterEnemy4, {SDLK_4}, "STR_CENTER_ON_ENEMY_4", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy5", (SDL_KeyWrapper *) &keyBattleCenterEnemy5, {SDLK_5}, "STR_CENTER_ON_ENEMY_5", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy6", (SDL_KeyWrapper *) &keyBattleCenterEnemy6, {SDLK_6}, "STR_CENTER_ON_ENEMY_6", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy7", (SDL_KeyWrapper *) &keyBattleCenterEnemy7, {SDLK_7}, "STR_CENTER_ON_ENEMY_7", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy8", (SDL_KeyWrapper *) &keyBattleCenterEnemy8, {SDLK_8}, "STR_CENTER_ON_ENEMY_8", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy9", (SDL_KeyWrapper *) &keyBattleCenterEnemy9, {SDLK_9}, "STR_CENTER_ON_ENEMY_9", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleCenterEnemy10", (SDL_KeyWrapper *) &keyBattleCenterEnemy10, {SDLK_0}, "STR_CENTER_ON_ENEMY_10", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyBattleVoxelView", (SDL_KeyWrapper *) &keyBattleVoxelView, {SDLK_F10}, "STR_SAVE_VOXEL_VIEW", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyInvCreateTemplate", (SDL_KeyWrapper *) &keyInvCreateTemplate, {SDLK_c}, "STR_CREATE_INVENTORY_TEMPLATE", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyInvApplyTemplate", (SDL_KeyWrapper *) &keyInvApplyTemplate, {SDLK_v}, "STR_APPLY_INVENTORY_TEMPLATE", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyInvClear", (SDL_KeyWrapper *) &keyInvClear, {SDLK_x}, "STR_CLEAR_INVENTORY", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("keyInvAutoEquip", (SDL_KeyWrapper *) &keyInvAutoEquip, {SDLK_z}, "STR_AUTO_EQUIP", "STR_BATTLESCAPE"));
...
#ifdef __SWITCH__
	_info.push_back(OptionInfo("controllerPointerSpeed", &controllerPointerSpeed, 10, "STR_CONTROLLER_POINTER_SPEED", "STR_GENERAL"));
#endif
